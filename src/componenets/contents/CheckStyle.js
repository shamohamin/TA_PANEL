...
public class CheckStyleTest {
    ...
    public void testCheckStyleIndentation() {
        ...
        System.out.println( "Found" + errors + "CheckStyleErrors.");
        System.out.println(sos.toString());
        assertTrue(errors + "CheckStyleErrorsFound." + sos.toString(), errors == 0);
    ...
    public void testCheckStyleNaming() {
        ...
        List files = new ArrayList();
        listFiles(files, ROOT, "java" );
        System.out.println( "Found" + files.size() + "JavaSourceFiles." );
         ...
         */
        checker.destroy();
        System.err.println( "$$$GRADER$$$|{type:SCORE,amount:1,reason:Naming.}|$$$GRADER$$$" );
    }
